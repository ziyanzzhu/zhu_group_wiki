...
This tutorial includes daily wiki page editing and group wiki repo management.

---

## Part 0 — Zero friction start with wiki

For group members who prefer drafting in note taking apps:

1. Write your content as usual (Notion/Obsidian/Google Docs/etc)
...
```bash
git clone https://github.com/ziyanzzhu/zhu_group_wiki
cd wiki
```
...
│   ├── dft-tutorial.qmd         ← DFT/ML team tutorial
